...
while True:
    ...
    if probabilityValue > threshold:
        cv2.putText(imgOri, str(classIndex) + " " + str(getCalssName(classIndex)), (120, 35), font, 0.75, (0, 0, 255),
                    2, cv2.LINE_AA)
        cv2.putText(imgOri, str(round(probabilityValue * 100, 2)) + "%", (180, 75), font, 0.75, (0, 0, 255), 2,
                    cv2.LINE_AA)
    cv2.imshow("Result", imgOri)
    if getCalssName(classIndex) == 'Stop' or classIndex == 10:
        pass
